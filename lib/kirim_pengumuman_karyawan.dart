...
class KirimPengumumanKaryawanScreen extends StatefulWidget {
  ...
  @override
  State<KirimPengumumanKaryawanScreen> createState() =>
      _KirimPengumumanKaryawanScreenState();
}

class _KirimPengumumanKaryawanScreenState
    extends State<KirimPengumumanKaryawanScreen>
  ...
  String _karyawanUsername = 'karyawan';
  ...
  Future<void> _loadUserData() async {
    ...
    try {
      ...
      if (doc.exists) {
        ...
        setState(() {
          _userData = data;
          _karyawanUsername = data?['username'] ?? 'karyawan';
        });
      }
    } catch (_) {}
  }
  ...
  Future<void> _kirimPengumuman() async {
    ...
    try {
      ...
      final pengirim = _karyawanUsername;
      ...
      final docRef =
        ...
        'prioritas': 'Normal',
        'pengirim': pengirim,
        'pengirim_email': user?.email ?? 'karyawan',
        'tipe': tipeString,
      ...
      final success = await _firestoreService.createNotificationForAllEmployees(
        ...
        pengirim: pengirim,
        pengirimEmail: user?.email ?? 'karyawan',
      ...
      if (mounted) {
        ...
        final msg = success
            ...
            : 'Pengumuman tersimpan tapi gagal kirim notifikasi';
  ...
  Future<void> _hapusPengumuman(String id, String judul) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Yakin hapus pengumuman "$judul"?',
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Hapus Semua Pengumuman?',
            style: GoogleFonts.lato(fontWeight: FontWeight.w900, color: kRed)),
        content: Text('Semua pengumuman akan dihapus permanen.',
            style: GoogleFonts.lato(fontSize: 13, color: kTextDark)),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(ctx, false),
  ...
  void _showDetailDialog(Map<String, dynamic> item) {
    ...
    String pengirim = item['pengirim'] ?? 'karyawan';
      ...
      builder: (ctx) => Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(colors: [kWhite, Color(0xFFF8F9FF)]),
          ...
          children: [
            ...
            TextFormField(
                ...
                decoration: _inputDecoration(
                    'Masukkan judul pengumuman...', Icons.title),
            ...
            TextFormField(
                ...
                maxLines: 5,
                decoration: _inputDecoration(
                        'Tulis isi pengumuman di sini...', Icons.edit_note)
  ...
  Widget _successBtn() {
    return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('TERKIRIM!',
              style: GoogleFonts.lato(
                  fontSize: 14, fontWeight: FontWeight.w900, color: kWhite))
        ]));
  }
      ...
      children: [
        Row(children: [
          ...
          if (!_loadingRiwayat && _riwayat.isNotEmpty)
            _actionBtn(Icons.delete_sweep, kRed, _hapusSemuaPengumuman,
  ...
  Widget _emptyRiwayat() {
    return Container(
      ...
      child: Column(children: [
        ...
        Text('Pengumuman yang kamu kirim akan muncul di sini',
