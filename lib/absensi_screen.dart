...
class _AbsensiScreenState extends State<AbsensiScreen>
  ...
  // ─── Face Detection (simulasi) ────────────────────────────────────────────
  void _startFaceDetection() async {
    await Future.delayed(const Duration(seconds: 3));
    if (!mounted || !_camActive) return;
    setState(() {
      _faceDetected   = true;
      _namaCtrl.text  = 'M.SIFAUL QULUB';
    });
  }
              ...
              ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: _pos != null
                      ? GoogleMap(
                          ...
                          markers: {
                            ...
                            Marker(
                              ...
                              position: LatLng(LocationService.storeLat,
                                  LocationService.storeLng),
                              infoWindow: InfoWindow(
                                  title: LocationService.storeName),
                      ...
                      // Mode bebas lokasi → tampilkan peta toko saja
                      : GoogleMap(
                          initialCameraPosition: CameraPosition(
                            target: LatLng(LocationService.storeLat,
                                LocationService.storeLng),
                            zoom: 16,
                          ),
                          markers: {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.pop(context, true);  // kembali ke HomeScreen
                  },
            ...
            children: [
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    _camActive ? 'MATIKAN KAMERA' : 'AKTIFKAN KAMERA',
                    style: const TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (_absenDimanaSaja)
                ...
                _badge(
                  _locValid ? 'TERDETEKSI' : 'DI LUAR LOKASI',
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (!_absenDimanaSaja && _locDetected)
                        Text(
                          '${_dist.toStringAsFixed(0)} m dari toko',
                          style: TextStyle(
                              fontSize: 10,
                              fontWeight: FontWeight.w700,
          ...
          // Mini map saat lokasi terdeteksi
          ...
          // Tombol deteksi manual saat kamera mati
  ...
  Widget _buildSubmitBtn(
      String typeLabel, Color typeColor, IconData typeIcon) {
